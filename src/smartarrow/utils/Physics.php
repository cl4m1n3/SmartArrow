...
class Physics extends Math
{
    ...
    {
        if (($multiplier = $target_speed * $projeсtile_flight_time) > 50) {
            return ($motion->multiply(50))->subtractVector($motion);
        }

        return ($motion->multiply($multiplier))->subtractVector($motion);
    }
}
